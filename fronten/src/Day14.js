...
//event handling
// it is the processmof the responding the user actions such as clicking a button, typing in an input FileSystemDirectoryHandle, hovering over a Element, or submiting a form

// user action click(button) ---- function executes(handleClick()) ----- ui updates (button has been clicked)



//forms it is used to collect info form users
//login page
//signup page
//contact us page
...
//flow of react form
//user types (swestha) --- onChange() -- updates state (usestate("")) -- input value changes -- ui updates
//controlled components
//a controlled components is an input elements whose value is controlled by react state
//why controlled components?
//-- easy validation
// -- easy from submission
// -- real time updates
// -- better data management


//react-router-dom
// it is a library that enables client side routing in reat applications.
